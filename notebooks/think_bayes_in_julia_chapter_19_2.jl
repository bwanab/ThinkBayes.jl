...
# ╔═╡ 4e5af5b1-8baa-409a-8e97-ec61f7831a52
...
weights = DataFrame(column=columns[2:end], weight=reshape(model.weight, 6))

# ╔═╡ 80e4f9b8-d021-4994-bbfd-b1b2f846c77a
begin
	scatter(model(X_train), Y_train, legend=false, color=:red)
...
manifest_format = "2.0"
project_hash = "7f6222099e267da4ab8f236bff92b4ff33bc871a"
