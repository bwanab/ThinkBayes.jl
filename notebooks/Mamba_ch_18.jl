...
# ╔═╡ c35a197e-0455-11ed-2b8f-f3e19d90942e
using Distributed, GraphViz

# ╔═╡ eb57dffa-a15a-4ff4-9003-929541c2345a
@everywhere using Mamba

# ╔═╡ 218701a6-9bd2-4010-bd10-272157f9bb48
line = Dict{Symbol, Any}(
  :x => [1],
  :goals => [1]
)

# ╔═╡ 9b9d095e-40e4-4ac3-a044-906eb3216e0f
model = Model(
  goals = Stochastic(1,
    (lam) -> Gamma(lam * 1.0),
    false
...
# ╔═╡ a0cc5120-defd-4ea9-92b0-90ca0c96dd06
inits = [
  Dict{Symbol, Any}(
    :goals => line[:goals],
...
# ╔═╡ 0d49e64f-27ae-4a53-83d2-0eddabac44b4
begin
	scale1 = [0.5, 0.25]
	summary1 = identity
	eps1 = 0.5
...
# ╔═╡ b43547dc-681d-4546-851b-f6511091e3b3
scheme = [
  NUTS(:lam)
]


# ╔═╡ af4f2a2f-1cd0-44d8-9244-50ee9161e6e8
setsamplers!(model, scheme)


# ╔═╡ 5fa118e2-1e0b-4497-adcc-9044c1586b1c
GraphViz.Graph(graph2dot(model))

# ╔═╡ 3dafb675-4d86-47a5-8807-1324776f0102
sim = mcmc(model, line, inits, 2000, burnin=1000, chains=1)


# ╔═╡ 9325ad2d-eb8a-49f5-9825-ef827faf5075
x = predict(sim)

# ╔═╡ a5fb22d1-38ba-41fb-bc0f-db76ae680da8
preds = reshape(x.value, 1000)

# ╔═╡ c1306fda-ea67-44f7-9fbb-f10320fa964a
...
[[deps.Mamba]]
deps = ["Cairo", "Calculus", "Compose", "DelimitedFiles", "Distributed", "Distributions", "Gadfly", "LightGraphs", "LinearAlgebra", "PDMats", "Printf", "Reexport", "Serialization", "Showoff", "SparseArrays", "SpecialFunctions", "Statistics", "StatsBase"]
git-tree-sha1 = "c3b05b806e24ca02f0d4145a41593642aa386a1a"
