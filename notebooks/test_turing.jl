...
# ╔═╡ c9963b72-fec8-11ec-1a5f-21e542081f4c
using StatsPlots, Turing, Random

# ╔═╡ d459a1c4-1dc4-487f-933a-54357a3598ea
p_true = 0.5

# ╔═╡ 55fefb6b-c44e-4b06-be43-cb86c377454c
Ns = 0:100

# ╔═╡ e19e6d4f-bb47-4a28-855b-a4f2fac9823e
begin
	#Random.seed!(12)
	data = rand(Bernoulli(p_true), last(Ns))
end

# ╔═╡ 22b23453-2b0d-4fd8-84db-706307419360
sum(data)

# ╔═╡ d541a49f-e4c2-4c92-9a5b-4003094e912b
...
# ╔═╡ 71a55502-fa75-4fd8-8f41-b0f679942057
begin
	iterations = 1000
	ϵ = 0.05
	τ = 10
...
# ╔═╡ 83ebb52e-661f-4205-ad44-e9f9c519d69f
histogram(chain[:p])

# ╔═╡ 3fbe98ac-96fd-4c07-9a32-e7c657516bdb
describe(chain)

# ╔═╡ 0c3e9943-a021-4518-9cd6-b4089aaf9d59
plot(chain, size=(650, 200))
